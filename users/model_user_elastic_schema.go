...
type UserElasticSchema struct {
	...
	LastSuccessfulAuth string `json:"last_successful_auth,omitempty"`
	LastUnsuccessfulAuth string `json:"last_unsuccessful_auth,omitempty"`
	LastWebLogin string `json:"last_web_login,omitempty"`
